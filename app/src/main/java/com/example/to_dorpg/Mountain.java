...
public class Mountain extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mountain);

        video = (VideoView) findViewById(R.id.mountain_view);
        ...
        AlertDialog.Builder adBd = new AlertDialog.Builder(Mountain.this);
        adBd.setTitle("Wow!!");
        adBd.setIcon(R.drawable.get_orange);
        adBd.setMessage("You find something!");
        adBd.setPositiveButton("Keep it!", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(Mountain.this, MainActivity.class);
    ...
    private void playVideoRaw() {
        ...
        String uri = "android.resource://" + getPackageName() + "/" + R.raw.mountain;
