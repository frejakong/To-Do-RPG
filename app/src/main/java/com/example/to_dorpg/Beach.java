...
public class Beach extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beach);

        video = (VideoView) findViewById(R.id.beach_view);
        ...
        AlertDialog.Builder adBd = new AlertDialog.Builder(Beach.this);
        adBd.setTitle("Wow!!");
        adBd.setIcon(R.drawable.get_blue);
        adBd.setMessage("You find something!");
        adBd.setPositiveButton("Keep it!", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(Beach.this, MainActivity.class);
